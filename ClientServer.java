...
public class ClientServer {
	...
	public static void main(String [] args){
		...
		Object selection = JOptionPane.showInputDialog(null, "Login as : ", "myExercise", JOptionPane.QUESTION_MESSAGE, null, selectioValues, initialSection);
